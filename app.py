...
def main():
    ...
    # City input card at the top of the main page (smaller, centered, with only centered text)
    st.markdown("""
    <div style="
        max-width: 320px;
        ...
        min-height: 90px;
    ">
        <h4 style="margin: 0; color: white; font-size: 1.08rem; font-weight: bold; text-align: center; width: 100%;">Enter City</h4>
    """, unsafe_allow_html=True)
